...
@Component(SecOfficerActorStrategy.NAME)
public class SecOfficerActorStrategy implements DefaultProcessActorAssignmentStrategy {

    public static final String NAME = "credit_SecOfficerActorStrategy";
    @Inject
